...
!function($) {
    ...
    GoogleMap.prototype.createMarkers = function($container) {
        ...
        map.addMarker({
          ...
          infoWindow: {
            content: '<p>Casa Mira Resendences</p>'
          }
        });
    ...
    GoogleMap.prototype.init = function() {
      ...
      $(document).ready(function(){
        ...
        //routes
        $this.createWithRoutes('#gmaps-route',15.9989, 120.2859);

        //types
        $this.createMapByType('#gmaps-types', 15.9989, 120.2859);

        //statu
        $this.createWithMenu('#gmaps-menu', 15.9989, 120.2859);
      });
    },
    //init
