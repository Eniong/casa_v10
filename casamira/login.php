  ...
  <div class="wrapper-page">
    <div class="card-box">
      <div class="panel-heading">
        <h3 class="text-center">Sign In to <strong class="text-custom">Casa Mira</strong></h3>
      </div>
      ...
      <div class="panel-body">
          <form class="form-horizontal m-t-20" method="post" action="login.php">
            ...
            <div class="form-group text-center m-t-40">
              <div class="col-xs-12">
                <button class="btn btn-pink btn-block text-uppercase waves-effect waves-light" type="submit" name="login_user">
                  Login
                </button>
              </div>
            </div>
            ...
            <div class="col-sm-12 text-center">
              <p>
                Not yet a member?<a href="register.php" class="text-primary m-l-5"><b>Sign Up</b></a>
              </p>
           </div>
